      ...
      <div class="col-lg-9">
        ...
        <div class="container">
          <div class="center-block">
            <h3>제품 설명</h3>
            <hr>
            <form action="<%=request.getContextPath()%>/insert.sa" method="post" enctype="multipart/form-data">
              <label for="pId"><h5>제품번호 : </h5></label>
              <input type="text" name="pId" style="width: 702px">

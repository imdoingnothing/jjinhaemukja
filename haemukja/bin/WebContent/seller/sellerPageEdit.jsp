    ...
    <div class="row">
      <div class="col-lg-2">
        <div class="list-group">
          <h4><a href="sellerpage_register.html">제품 등록</a></h4>
          <h4><a href="sellerpage_explain.html">제품 설명</a></h4>
      ...
      <div class="col-lg-9">
        ...
        <div class="container">
          <div class="center-block">
            <h3>상세페이지 수정</h3>
            <hr>
            <form action="<%=request.getContextPath()%>/update.sa" method="post" enctype="multipart/form-data">
              <label for="sbNo"><h5>판매글번호 : </h5></label>
              <input type="text" name="sbNo" style="width: 683px"><br>
